...
//             System.out.println("now you left with "+i+" choices");
//         }
...
//         }
//     }
//     System.out.println("The Total no. of time you won is "+ cnt);
...
public class Task1 {
    ...
    public static void main(String[] args) {
        Task1 game = new Task1(); // Create an instance of Task1
        ...
        for (game.i = 3; game.i >= 0; game.i--) {
            ...
            if (no == temp) {
                ...
                cnt++;
                //int f = Integer.parseInt(game.con.readLine());
                game.check();
            } else if (no > temp) {
                System.out.println("Your guess is too high");
